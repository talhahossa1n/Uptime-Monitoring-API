...
/*
 * Title: Check Handler
 * Description: Handler to to handle user defined checks.
                            ...
                            if (tokenIsValid) {
                                ...
                                if (userChecks.length < maxChecks) {
                                    ...
                                    data.create('checks', checkId, checkObject, (err3) => {
                                        if (!err3) {
                                            // add check id to he user's object
                                    ...
                                    data.read('users', parseJSON(checkData).userPhone, (err3, userData) => {
                                        ...
                                        if (!err3 && userData) {
                                            ...
                                            if (checkPosition > -1) {
                                                ...
                                                callback(500, {
                                                    error: 'The check id you are trying to delete was not found in server',
                                                });
                                            }
                                        } else {
                                            callback(500, { error: 'You have a problem in your request' });
